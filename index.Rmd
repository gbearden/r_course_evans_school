...
**Time: 5:30-8:20pm**  
**Class Dates: 10/4, 10/11, 10/18, 10/25**  
...
- Attend four classes. Class dates are 10/4, 10/11, 10/18, & 10/25. A full class is 2 hours and 50 minutes, breaks included.
- Submit 2 "stakeholder-ready" data visualizations by November 4 or before (See [example plots](https://github.com/gbearden/r_course_evans_school/blob/master/plots/))
...
#### October 4 | [Part 1](https://gbearden.github.io/r_course_evans_school/slides/part_1/)
...
#### October 11 | [Part 2](https://gbearden.github.io/r_course_evans_school/slides/part_2/)
...
#### October 18 | [Part 3](https://gbearden.github.io/r_course_evans_school/slides/part_3/)
...
#### October 25 | [Part 4](https://gbearden.github.io/r_course_evans_school/slides/part_4/)
...
* Install R [on a Mac with an Intel chip](https://cran.r-project.org/bin/macosx/base/R-4.2.1.pkg), [on a Mac with an M1 chip](https://cran.r-project.org/bin/macosx/big-sur-arm64/base/R-4.2.1-arm64.pkg), or [on a PC](https://cran.r-project.org/bin/windows/base/R-4.2.1-win.exe)
* Install RStudio [on a Mac](https://download1.rstudio.org/desktop/macos/RStudio-2022.07.1-554.dmg) or [on a PC](https://download1.rstudio.org/desktop/windows/RStudio-2022.07.1-554.exe)
...
* [RStudio](https://www.rstudio.com/). The R IDE (integrated development environment) we will use in the course.
...
* [Cheat sheets](https://www.rstudio.com/resources/cheatsheets/)
    ...
    + [Data transformation](https://github.com/rstudio/cheatsheets/blob/main/data-transformation.pdf). I use this all the time when working with dplyr.
    + [Data tidying](https://github.com/rstudio/cheatsheets/blob/main/tidyr.pdf). If the dplyr cheat sheet were Batman, the tidyr cheat sheet is Robin.
    ...
    + [Lubridate](https://github.com/rstudio/cheatsheets/blob/main/lubridate.pdf). Dates in R are a pain in the butt. This cheat sheet and the lubridate library will make your life easier.  
...
* [Top 50 ggplot2 Visualizations](http://r-statistics.co/Top50-Ggplot2-Visualizations-MasterList-R-Code.html). Check this out when you want to produce new plot types. It is full of good ideas.
...
---
Here are syllabi from previous quarters: [Autumn 2021](https://github.com/gbearden/r_course_evans_school/blob/master/archive/syllabus_a21.md), [Autumn 2020](https://github.com/gbearden/r_course_evans_school/blob/master/archive/syllabus_a20.md), [Autumn 2019](https://github.com/gbearden/r_course_evans_school/blob/master/archive/syllabus_a19.md), [Autumn 2018](https://github.com/gbearden/r_course_evans_school/blob/master/archive/syllabus_a18.md), [Winter 2018](https://github.com/gbearden/r_course_evans_school/blob/master/archive/syllabus_w18.md)
