...
Try adding a theme to the plot you made from the `climate` data in the last class
...
Try asking [ChatGPT](https://chat.openai.com/) to create a color palette that you can when building plots. Once you have a palette, try replacing the pre-built palette you just added to the plot created with `climate`.
...
- Dodge the bar segments by adding `position = "dodge"` to `geom_bar()`
