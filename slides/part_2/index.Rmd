...
- Workshop slides will always be available
- Check out R for Stata users in the syllabus
- Check out notes from the first class and an example script in the syllabus
- You can learn enough SQL in 5-10 hours to include SQL skills on your resume
...
airbnb %>% 
  mutate(
    cost_per_room = price / accommodates,
