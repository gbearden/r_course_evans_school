...
- The function is intended for the data type  
  - For example you may not want to run `min()` on a character string of addresses  
...
**Exercise - 10 minutes**  
With `climate`, create a new tibble called `dif_uncertainty`. The tibble should contain a variable called `dif` that tells you the difference between the smallest and largest uncertainty values for all rows with years after 1800. 
