...
- Data management and multiple file versions  
  - Manage versioning through in script
  - Most file hosting services (like Dropbox) offer version control
...
How would you create a variable that flags a deficit of listings for the three `room_types` (let's say "deficit" is defined as fewer than 100 hosts)?
...
**Exercise - 10 minutes**  
With `climate`, create a new tibble called `dif_uncertainty`. The tibble should contain a variable called `dif` that tells you the difference between the smallest and largest uncertainty values for years after 1800. 
