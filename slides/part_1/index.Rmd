...
author: "Graham Bearden and Oeuyown Kim"
...
- [Install VS Code](https://code.visualstudio.com/download)
  - Install [REditorSupport](https://marketplace.visualstudio.com/items?itemName=reditorsupport.r)
  - Install R library languageserver (`install.packages("languageserver")`)
...
- Leverage AI to maintain foundational knowledge as an R programmer  
  - Basics like setting up RStudio or another IDE (Integrated Development Environment), running and writing code, and further exploring core concepts in R like data types and how functions work  
  - For example, ask your AI assistant to respond to the prompt: *"Explain the anatomy of an R function"*
...
- R programmer AI tools
  ...
  - Desktop tools  
  - Models  
  - Cloud-based Ops orchestration
- Common prompting strategies
  - Role Prompting (*“Act as an R programming instructor for beginners and explain functions.”*)
